...
| Skill | Description |
|-------|-------------|
| [chrome-cdp](skills/chrome-cdp/) | Interact with local Chrome browser via DevTools Protocol — no Puppeteer, works with 100+ tabs. Based on [pasky/chrome-cdp-skill](https://github.com/pasky/chrome-cdp-skill) |
